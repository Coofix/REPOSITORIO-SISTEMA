...
<table>
    ...
    <tr>
        ...
        <td>
        <a href="editar-paciente.php?id_paciente=<?php echo $linha['id_paciente']; ?>">Editar </a>
            <a href="javascript: if(confirm('Tem certeza que deseja deletar o cliente <?php echo $linha['nome_cliente']; ?>'))
            location.href='deletar-cliente.php?id_client=<?php echo $linha['id_paciente']; ?>';">Deletar </a>
        </td>
    </tr>
